...
use crate::{U32PowerOf2, any::layout::Repr};
...
impl UnsizedStruct {
    ...
    pub fn change_all_repr(&mut self, repr: Repr) {
        self.repr = repr;
        self.apply_to_sized_fields(|field| {
            field.ty.change_all_repr(repr);
        });
        self.apply_to_last_unsized(|last_unsized| {
            last_unsized.array.change_all_repr(repr);
        });
    }
}
    ...
    pub const fn align(&self, repr: Repr) -> U32PowerOf2 {
        match repr {
            ...
            Repr::Wgsl | Repr::WgslUniform => match self {
                ...
                ScalarType::F32 | ScalarType::U32 | ScalarType::I32 | ScalarType::Bool => U32PowerOf2::_4,
