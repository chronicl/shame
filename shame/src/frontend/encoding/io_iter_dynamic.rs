...
impl VertexBufferElement {
    ...
    // TODO consider making this public, as it could use the slot and location counter effecively
    #[track_caller]
    pub(crate) fn attributes_from_type_layout(self, layout: TypeLayout<constraint::Vertex>) -> Vec<Any> {
        let attributes = layout.as_vertex_attributes();
...
impl VertexAttributeIter {
    fn new(
        ...
        Self {
            ...
            location_counter,
            lookup,
            layout_calculator: LayoutCalculator::new(packed, TypeLayoutRules::Wgsl),
        }
    }
