use crate::frontend::rust_types::type_layout2::LayoutCalculator;
...
impl Vector {
    ...
    pub const fn byte_align(&self) -> U32PowerOf2 {
...
impl Atomic {
    ...
    pub const fn byte_align(&self) -> U32PowerOf2 { self.scalar.as_scalar_type().align() }
}
